...
import { StudentSchema, TeacherSchema } from "@/lib/validationSchemas";
import { useRouter } from "next/navigation";
import { toast } from "react-toastify";
import { createStudent, createTeacher, updateStudent, updateTeacher } from "@/lib/serverActions";
    ...
    return (
        <form onSubmit={onSubmit} className="flex flex-col gap-8">
            ...
            <div className="flex justify-between flex-wrap gap-4">
                ...
                <InputFieldForm label="Parent Id" name="parentId"  defaultValue={data?.parentId} register={register} error={errors.parentId}/>
                {data && (
                ...
                <div className="flex flex-col gap-2 w-full md:w-1/4 ">
                    ...
                    {errors.gradeId?.message && (
                        <p className="text-red-500 text-xs">{errors.gradeId.message.toString()}</p>
                    )}
                </div>
                <div className="flex flex-col gap-2 w-full md:w-1/4 ">
                    ...
                    {errors.classId?.message && (
                        <p className="text-red-500 text-xs">{errors.classId.message.toString()}</p>
                    )}
                </div>
            </div>
            {state.error && (
